...
------------ Options ------------
L["Add character names and assign custom nicknames for raid frames"] = "Agregar nombres de personaje y asignar apodos personalizados para los marcos de banda"
L["Debug"] = "Depuración"
...
L["Add New Entry"] = "Agregar nueva entrada"
L["Character Name"] = "Nombre del personaje"
L["Nickname"] = "Apodo"
L["Add"] = "Agregar"
L["Import from GRM"] = "Importar desde GRM"
L["Add a nickname for multiple characters in your guild at once using data from Guild Roster Manager (GRM)"] = "Agrega un apodo a múltiples personajes de tu hermandad a la vez usando datos del Guild Roster Manager (GRM)"
L["Current Nicknames"] = "Apodos actuales"
L["Delete"] = "Eliminar"
L["Add to Nickname"] = "Agregar al apodo"
...
L["GRM is not yet initialized. Please try again soon."] = "GRM aún no está inicializado. Por favor, inténtalo de nuevo en breve."
...
L["Enter the name of a character in your guild to find alts or mains for"] = "Ingresa el nombre de un personaje de tu hermandad para encontrar sus alts o personajes principales"
L["Enter a nickname for these characters"] = "Ingresa un apodo para estos personajes"
L["Import"] = "Importar"
L["{count} characters will be imported with nickname {nickname}"] = "{count} personajes se importarán con el apodo {nickname}"
